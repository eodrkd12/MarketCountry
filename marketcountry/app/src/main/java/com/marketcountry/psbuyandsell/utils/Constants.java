package com.marketcountry.psbuyandsell.utils;
...
public interface Constants {
    ...
    int REQUEST_CODE__SIXTH_GALLERY = 1016;
    int REQUEST_CODE__SEVENTH_GALLERY = 1017;
    int REQUEST_CODE__EIGHTH_GALLERY = 1018;
    int REQUEST_CODE__PERMISSION_CODE = 1019;

    int REQUEST_CODE__FIRST_CAMERA = 1020;
    int REQUEST_CODE__SEC_CAMERA = 1021;
    int REQUEST_CODE__THIRD_CAMERA = 1022;
    int REQUEST_CODE__FOURTH_CAMERA = 1023;
    int REQUEST_CODE__FIFTH_CAMERA = 1024;
    int REQUEST_CODE__SIXTH_CAMERA = 1025;
    int REQUEST_CODE__SEVENTH_CAMERA = 1026;
    int REQUEST_CODE__EIGHTH_CAMERA = 1027;

    int REQUEST_CODE__FIRST_CUSTOM_CAMERA = 1028;
    int REQUEST_CODE__SEC_CUSTOM_CAMERA = 1029;
    int REQUEST_CODE__THIRD_CUSTOM_CAMERA = 1030;
    int REQUEST_CODE__FOURTH_CUSTOM_CAMERA = 1031;
    int REQUEST_CODE__FIFTH_CUSTOM_CAMERA = 1032;
    int REQUEST_CODE__SIXTH_CUSTOM_CAMERA = 1033;
    int REQUEST_CODE__SEVENTH_CUSTOM_CAMERA = 1034;
    int REQUEST_CODE__EIGHTH_CUSTOM_CAMERA = 1035;

    int REQUEST_CODE__BUYER_CHAT_FRAGMENT = 1036;
    int REQUEST_CODE__SELLER_CHAT_FRAGMENT = 1037;
